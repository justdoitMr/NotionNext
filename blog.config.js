...
const BLOG = {
  ...
  // giscus @see https://giscus.app/ 增加评论  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'justdoitMr/giscus_comment', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
