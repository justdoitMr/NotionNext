...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '45b2e81f7e634154b18609149a7b9d1d',
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'rzf18069001547@163.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://www.bilibili.com/?spm_id_from=333.788.0.0', // B站主页
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || '', // Youtube主页
  CONTACT_XIAOHONGSHU: process.env.NEXT_PUBLIC_CONTACT_XIAOHONGSHU || '', // 小红书主页
  CONTACT_ZHISHIXINGQIU: process.env.NEXT_PUBLIC_CONTACT_ZHISHIXINGQIU || 'https://wx.zsxq.com/dweb2/index/group/51111528245844', // 知识星球
  ...
  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'https://codinglab.online', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '沪ICP备20200606188', // 备案号 闽ICP备XXXXXXX
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoocomment-justdoitmrs-projects.vercel.app/', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  ...
  // giscus @see https://giscus.app/ 增加评论
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'justdoitMr/giscus_comment', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'codinglab少儿编程实验室', // 站点描述，被notion中的页面描述覆盖
